...
def usage():
    ...
    print "Tools By TanzzXAngga "
    print "Tools By TanzzXAngga"
    print "JANGAN MENGATAS NAMAKAN TEAM KALO TIRAK MENGENAL TANZZ DAN ANGGA "
...
def flood(victim, vport, duration):
    ...
    while 1:
        ...
        sent = sent + 1
        print "Attacking %s Server &  %s By TanzzXAngga%s "%(sent, victim, vport)
